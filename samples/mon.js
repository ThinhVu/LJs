window.onload = function() {
    ...
    l.c.register('perf-mon', function () {
        this.template = function () {
            return l("div", null, null, [
                l("table", { class: "table table-striped latest-data" }, {}, [
                    l("tbody", null, null,
                        data.map(function (db) {
                            return l("tr", { key: db.dbname }, null, [
                                l("td", { class: "dbname" }, null, [db.dbname]),
                                l("td", { class: "query-count" }, null, [
                                    l("span", { class: db.lastSample.countClassName }, null, [db.lastSample.nbQueries])
                                ]),
                                db.lastSample.topFiveQueries.map(function (query) {
                                    return l("td", { class: query.elapsedClassName }, null, [
                                        query.formatElapsed,
                                        l("div", { class: "popover left" }, null, [
                                            l("div", { class: "popover-content" }, null, [query.query]),
                                            l("div", { class: "arrow" })
                                        ])
                                    ])
                                })
    ...
    l.attach(document.getElementById('app'), perf);
    update();
}